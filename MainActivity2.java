...
public class MainActivity2 extends AppCompatActivity {
    ...
    private LottieAnimationView LocationButton;
    LottieAnimationView FeverTester;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LottieAnimationView l1 = findViewById(R.id.button2);
        ...
        b1.setOnClickListener(v -> {
           ...
           l1.setOnLongClickListener(v -> {
               ...
               try {
                    ...
                    gtr=E.getMessage().toString();
                    Toast.makeText(MainActivity2.this,gtr,Toast.LENGTH_SHORT).show();
                }
               Toast.makeText(getApplicationContext(), "PANIC BUTTON START", Toast.LENGTH_SHORT).show();
               return false;
           });

        l1.setOnClickListener(v -> makePhoneCall());
    }
